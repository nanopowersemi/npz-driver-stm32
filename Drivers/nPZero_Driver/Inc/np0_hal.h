...
#define NP0_I2C_ADDRESS			0x7a  // 0x3D np0 I2c address shifted left by 1 bit
 ...
 */
np0_status_e np0_hal_read(uint8_t slave_address, uint8_t slave_register,
 ...
 * @return np0_status_e Status
 */
np0_status_e np0_hal_write(uint8_t slave_address, uint8_t *pData, uint16_t size,
		uint32_t timeout);
